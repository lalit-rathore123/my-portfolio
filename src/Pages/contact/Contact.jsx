      ...
      <div className='contact__container container grid'>
        <div className='contact__data'>
          ...
          <p className='contact__description'>
            ...
            new projects, Creative ideas or opportunities to be a part f your visions.
          </p>
          ...
          <div className='contact__info'>
            <div className='info__item'>
              ...
              <div>
                ...
                <h4 className='info__desc'>rathorefitness78@gmail.com</h4>
              </div>
            </div>
            ...
            <div className='info__item'>
              ...
              <div>
                ...
                <h4 className='info__desc'>+91 7073379124</h4>
              </div>
            </div>
